...
class HubTest extends TestCase
{
    ...
    public function testGetAmountForRestaurant()
    {
        ...
        $this->assertEquals(1200, $hub->getAmountForRestaurant($order->reveal(), $flowerShop));
        $this->assertEquals(900, $hub->getAmountForRestaurant($order->reveal(), $bakery));
    }
}
